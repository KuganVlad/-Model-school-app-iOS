...
class GetTeacherDataList {
    typealias TeacherListInfoCompletion = (([[String:Any]]?) -> Void)

    func getTeacherListData(city: String, completion: TeacherListInfoCompletion?) {
        let url = URL(string: "http://localhost/authentication-jwt/api/get_teacher_list.php")!
