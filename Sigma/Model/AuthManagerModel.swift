...
class AuthMangerApplication {
    typealias AuthApplicationCompletion = (([String:Any]?) -> Void)

    func authManager(email: String, password: String, completion: AuthApplicationCompletion?) {
        let url = URL(string: "http://localhost/authentication-jwt/api/login_manager.php")!
