...
class GetUserListUpdate {
    typealias UserListUpdateCompletion = ((String?) -> Void)

    func getUserListUpdate(data: [String: Any], completion: UserListUpdateCompletion?) {
        let url = URL(string: "http://localhost/authentication-jwt/api/get_manager_user_update.php")!
