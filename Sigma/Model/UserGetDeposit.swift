...
class UserGetDeposit {
    typealias UserGetDepositCompletion = (([[String:Any]]?) -> Void)

    func getUserDepositData(id: String, completion: UserGetDepositCompletion?) {
        let url = URL(string: "http://localhost/authentication-jwt/api/get_all_deposit.php")!
