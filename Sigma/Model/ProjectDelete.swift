...
class ProjectDelete {
    typealias ProjectDeleteCompletion = ((String?) -> Void)

    func projectDelete(id: String, completion: ProjectDeleteCompletion?) {
        let url = URL(string: "http://localhost/authentication-jwt/api/project_delete.php")!
